...
class Container_27f1f7ee54 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_27f1f7ee54 $container)
			{
	...
	public function createServiceContainer(): Container_27f1f7ee54
	{
		return $this;
	}
