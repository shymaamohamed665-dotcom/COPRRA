...
class Container_116cb4e7ff extends _PHPStan_6597ef616\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0359(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_116cb4e7ff $container)
            {
    ...
    public function createServiceContainer(): Container_116cb4e7ff
    {
        return $this;
    }
