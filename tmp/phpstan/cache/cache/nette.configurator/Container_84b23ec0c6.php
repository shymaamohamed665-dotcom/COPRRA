...
// source: phar://C:\Users\Gaser\Desktop\COPRRA\vendor\phpstan\phpstan\phpstan.phar/conf/config.levelmax.neon
...
class Container_84b23ec0c6 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService045(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			[
				...
				'phar://C:\Users\Gaser\Desktop\COPRRA\vendor\phpstan\phpstan\phpstan.phar\conf\config.levelmax.neon',
				'phar://C:\Users\Gaser\Desktop\COPRRA\vendor\phpstan\phpstan\phpstan.phar\conf\config.level10.neon',
				'phar://C:\Users\Gaser\Desktop\COPRRA\vendor\phpstan\phpstan\phpstan.phar\conf\config.level9.neon',
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_84b23ec0c6 $container)
			{
	...
	public function createServiceContainer(): Container_84b23ec0c6
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'GIT_AUTHOR_DATE' => '@@1761095222 +0300',
