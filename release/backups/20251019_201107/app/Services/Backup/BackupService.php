...
class BackupService
{
     ...
     *
     * @psalm-return array{id: string, filename: string, type: string, size: int, size_formatted: string, created_at: string|null, description: string}
     */
    ...
    {
        return (is_string($name) ? $name : 'backup').'.zip';
    }
