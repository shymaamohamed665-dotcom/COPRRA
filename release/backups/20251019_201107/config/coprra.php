...
return [
    ...
    */
    ...
    'cache' => [
        'durations' => [
            ...
            'product' => env('CACHE_PRODUCT_TTL', 3600), // 1 hour
            'search' => env('CACHE_SEARCH_TTL', 3600), // 1 hour
            'price_comparison' => env('CACHE_PRICE_COMPARISON_TTL', 3600), // 1 hour
            'exchange_rate' => env('CACHE_EXCHANGE_RATE_TTL', 3600), // 1 hour
        ],
    ],
    ...
    */
    ...
    'shipping' => [
        'free_threshold' => env('FREE_SHIPPING_THRESHOLD', 100), // Free shipping over this amount
        'standard_fee' => env('STANDARD_SHIPPING_FEE', 10), // Standard shipping cost
    ...
    */
    ...
    'upload' => [
        ...
        'max_size_bytes' => env('MAX_UPLOAD_SIZE_BYTES', 10485760), // 10 MB
        'allowed_extensions' => [
    ...
    */
    ...
    'storage' => [
        'thresholds' => [
            'critical' => env('STORAGE_CRITICAL_THRESHOLD', 90), // 90% usage
            'warning' => env('STORAGE_WARNING_THRESHOLD', 80), // 80% usage
        ],
        'retention_days' => [
