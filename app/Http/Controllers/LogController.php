...
class LogController extends Controller
{
    ...
    {
        return $this->executeLogOperation(function () use ($allowedLevels) {
            if (! File::exists($this->logPath)) {
                return [
                    'success' => false,
                    'message' => 'Log file not found',
    ...
    private function filterLinesByLevels(array $lines, array $allowedLevels): array
    {
        ...
        return array_filter($lines, static function ($line) use ($allowedLevels): bool {
    ...
    {
        return $this->executeLogOperation(function () {
    ...
    private function applyLevelFilter(array $lines, Request $request): array
    {
        ...
        return array_filter($lines, static fn ($line): bool => str_contains($line, $level));
    }
