...
class PriceHelperTest extends TestCase
{
    ...
    /** @test */
    public function it_formats_price_with_default_currency(): void
    {
    ...
    /** @test */
    public function it_formats_price_with_specific_currency(): void
    {
    ...
    /** @test */
    public function it_formats_price_with_sar_currency(): void
    {
    ...
    /** @test */
    public function it_handles_non_existent_currency(): void
    {
    ...
    /** @test */
    public function it_calculates_price_difference_percentage(): void
    {
    ...
    /** @test */
    public function it_handles_negative_original_price(): void
    {
    ...
    /** @test */
    public function it_formats_positive_price_difference_string(): void
    {
    ...
    /** @test */
    public function it_formats_negative_price_difference_string(): void
    {
    ...
    /** @test */
    public function it_formats_zero_price_difference_string(): void
    {
    ...
    /** @test */
    public function it_identifies_good_deal(): void
    {
    ...
    /** @test */
    public function it_identifies_not_good_deal(): void
    {
        $allPrices = [100.0, 110.0, 120.0, 130.0];
    ...
    /** @test */
    public function it_handles_empty_prices_array_for_good_deal(): void
    {
    ...
    /** @test */
    public function it_gets_best_price_from_array(): void
    {
    ...
    /** @test */
    public function it_returns_null_for_empty_prices_array(): void
    {
    ...
    /** @test */
    public function it_converts_currency_to_sar(): void
    {
    ...
    /** @test */
    public function it_formats_price_range_with_same_prices(): void
    {
    ...
    /** @test */
    public function it_formats_price_range_with_different_prices(): void
    {
    ...
    /** @test */
    public function it_formats_price_range_with_non_existent_currency(): void
    {
    ...
    /** @test */
    public function it_calculates_accurate_percentage_for_small_differences(): void
    {
    ...
    /** @test */
    public function it_calculates_accurate_percentage_for_large_differences(): void
    {
