...
// Default to testing environment BEFORE creating the app
$_ENV['APP_ENV'] = $_ENV['APP_ENV'] ?? 'testing';
$_SERVER['APP_ENV'] = $_SERVER['APP_ENV'] ?? 'testing';

// Set test-specific drivers BEFORE app creation to prevent Redis dependency
$_ENV['BROADCAST_DRIVER'] = $_ENV['BROADCAST_DRIVER'] ?? 'null';
$_SERVER['BROADCAST_DRIVER'] = $_SERVER['BROADCAST_DRIVER'] ?? 'null';
$_ENV['REDIS_CLIENT'] = $_ENV['REDIS_CLIENT'] ?? 'predis';
$_SERVER['REDIS_CLIENT'] = $_SERVER['REDIS_CLIENT'] ?? 'predis';
$_ENV['CACHE_DRIVER'] = $_ENV['CACHE_DRIVER'] ?? 'array';
$_SERVER['CACHE_DRIVER'] = $_SERVER['CACHE_DRIVER'] ?? 'array';
