...
return new class extends Migration
{
    ...
    {
        Schema::table('products', function (\Illuminate\Database\Schema\Blueprint $table): void {
    ...
    {
        // Original type unknown; skipping reversal for `category_id` to avoid data loss.
        // Original type unknown; skipping reversal for `brand_id` to avoid data loss.
