...
@section('title', 'Edit ' . $brand->name . ' - ' . config('app.name'))
                    ...
                    <form action="{{ route('brands.update', $brand) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">URL-friendly version of the name (e.g., "nike" for "Nike")</div>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('brands.show', $brand) }}" class="btn btn-secondary me-md-2">Cancel</a>
